...
public class AddProductToCartTests extends TestHelpers {
    ...
    String firstProductLocator = "a[href=\"?add-to-cart=61\"]";
    String addProductButtonLocator = "button[name=\"add-to-cart\"]";
    String alertMessageLocator = "div[class=\"woocommerce-message\"]";
    ...
    String cartButtonLocator = "cart-contents";
    String differentProductLocator = "input[type=\"number\"]";
    ...
    public void addProductToCartTest() {
        ...
        wait.until(ExpectedConditions.visibilityOf(driver.findElement(By.cssSelector(alertMessageLocator))));
    ...
    public void addingManyItemsOfProductToCart() {
        ...
        //moving to cart page
        driver.findElement(By.className(cartButtonLocator)).click();

        //adding another item to cart from cart page
        driver.findElement(By.cssSelector(differentProductLocator)).sendKeys(Keys.ARROW_UP);
